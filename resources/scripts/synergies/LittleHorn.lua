...
---@param ent Entity
local function SpawnHornTear(player, ent)
...
mod:AddCallback(callbacks.PERFECT_PARRY, function(_, player, ent) SpawnHornTear(player, ent) end)
mod:AddCallback(callbacks.OFFENSIVE_STOMP_HIT, function(_, player, ent) SpawnHornTear(player, ent) end)
